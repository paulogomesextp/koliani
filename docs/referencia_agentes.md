# Referência técnica dos agentes — Koliani

Arquivo dos detalhes anteriores. Ler apenas a secção relevante. Para planeamento,
commits e consumo prevalece o AGENTS.md atual; a indicação histórica de commits
frequentes abaixo foi substituída por um commit no fim do lote validado.
