...
## com o jogo a correr.
const TEMPO_HARDCORE := [90.0, 110.0, 115.0, 115.0, 120.0, 120.0, 130.0, 125.0, 120.0, 150.0]
...
const REGIOES := [
	...
	{"id": "prisao", "nome": "Prisao dos Condenados", "niveis": [5, 6, 7]},
	{"id": "torres", "nome": "Torres Esquecidas", "niveis": [8]},
	{"id": "catacumbas", "nome": "Catacumbas do Abismo", "niveis": []},
	{"id": "cidade", "nome": "Cidade Corrompida", "niveis": []},
	{"id": "castelo", "nome": "Castelo de Zeriko", "niveis": [9]},
]
