...
## com o jogo a correr.
const TEMPO_HARDCORE := [90.0, 110.0, 115.0, 115.0, 120.0, 120.0, 130.0, 125.0, 135.0, 150.0, 130.0, 120.0, 135.0, 140.0, 160.0, 135.0, 150.0, 150.0, 140.0]
...
const REGIOES := [
	...
	{"id": "catacumbas", "nome": "Catacumbas do Abismo", "niveis": [15, 16, 17]},
	{"id": "cidade", "nome": "Cidade Corrompida", "niveis": []},
	{"id": "castelo", "nome": "Castelo de Zeriko", "niveis": [18]},
]
