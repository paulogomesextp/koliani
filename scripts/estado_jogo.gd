...
## com o jogo a correr.
const TEMPO_HARDCORE := [90.0, 110.0, 115.0, 115.0, 120.0, 120.0, 130.0, 125.0, 135.0, 150.0, 130.0, 120.0, 135.0, 140.0, 160.0, 135.0, 150.0, 150.0, 140.0, 145.0, 150.0, 130.0, 150.0]
...
const REGIOES := [
	...
	{"id": "cidade", "nome": "Cidade Corrompida", "niveis": [20, 21]},
	{"id": "castelo", "nome": "Castelo de Zeriko", "niveis": [22]},
]
